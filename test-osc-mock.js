...
ws.on('open', () => {
    ...
    console.log('[TEST] Sending FOH_CALL:', talkMsg);
    ...
    setTimeout(() => {
        ...
        console.log('[TEST] Sending SET_GAIN:', gainMsg);
    ...
    setTimeout(() => {
        ...
        console.log('[TEST] Sending FOH_CALL:', fohMsg);
...
ws.on('message', (data) => {
    try {
        ...
        console.log('[BACKEND RESPONSE]', JSON.stringify(msg, null, 2));
    } catch (e) {
